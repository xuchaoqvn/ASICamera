...
namespace ZWOptical.ASISDK
{
    public class ASICameraDll2
    {
        ...
        public struct ASI_SUPPORTED_MODE
        {
            ...
            public ASI_CAMERA_MODE[] SupportedCameraMode;// 这个数组将用来存储从SDK中返回的当前相机支持的模式 
        }
        ...
        private static extern ASI_ERROR_CODE ASIGetCameraSupportMode64(int iCameraID, out ASI_SUPPORTED_MODE mode);
        ...
        [DllImport("ASICamera2.dll", EntryPoint = "ASISetCameraMode", CallingConvention = CallingConvention.Cdecl)]
        private static extern ASI_ERROR_CODE ASISetCameraMode64(int iCameraID,  ASI_CAMERA_MODE mode);
        ...
        public static ASI_ERROR_CODE ASIGetCameraSupportMode(int iCameraID, out ASI_SUPPORTED_MODE modes) => ASIGetCameraSupportMode64(iCameraID, out modes);
        public static ASI_ERROR_CODE ASIGetCameraMode(int iCameraID, out ASI_CAMERA_MODE mode) => ASIGetCameraMode64(iCameraID, out mode);

        public static ASI_ERROR_CODE ASISetCameraMode(int iCameraID, ASI_CAMERA_MODE mode) => ASISetCameraMode64(iCameraID, mode);
        ...
        public static ASI_ERROR_CODE ASISetControlValue(int iCameraID, ASI_CONTROL_TYPE ControlType, int lValue, ASI_BOOL aslBool)
        { return IntPtr.Size == 8 /* 64bit */ ? ASISetControlValue64(iCameraID, ControlType, lValue, aslBool) : ASISetControlValue32(iCameraID, ControlType, lValue, aslBool); }
